...
public class Madlibs extends JFrame {
	...
	public Madlibs() {
		...
		setFont(new Font("Chalkboard SE", Font.PLAIN, 12));
		setBackground(new Color(107, 142, 35));
		setTitle("Dr. Rocky's GUI MadLibs");
		getContentPane().setBackground(new Color(85, 107, 47));
		getContentPane().setLayout(null);
		
		JLabel lblDrRockysWacky = new JLabel("Dr.Rocky's Wacky MadLibs App");
		lblDrRockysWacky.setFont(new Font("Hannotate TC", Font.BOLD, 20));
		lblDrRockysWacky.setHorizontalAlignment(SwingConstants.CENTER);
		lblDrRockysWacky.setBounds(106, 11, 322, 29);
		getContentPane().add(lblDrRockysWacky);
		...
		txtOutput.setForeground(new Color(210, 105, 30));
		txtOutput.setFont(new Font("Chalkboard SE", Font.BOLD, 18));
		txtOutput.setBackground(new Color(0, 128, 128));
